      ...
      <Transition.Root show={open}>
        ...
        >
          ...
          >
            <DialogRadix.Close
              className={
                'rounded absolute right-3.5 top-3.5 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500'
              }
            >
            ...
            <div className={cn('p-5', showIcon && 'sm:flex sm:gap-4')}>
              {showIcon ? (
                isDanger ? (
                  <div className='rounded-full mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center bg-red-100 sm:mx-0'>
                    <AlertTriangleIcon className='h-6 w-6 text-red-600' aria-hidden='true' />
                  </div>
                ) : (
                  <div className='rounded-full mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center bg-blue-100 sm:mx-0'>
