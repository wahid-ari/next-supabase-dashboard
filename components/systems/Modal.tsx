          ...
          >
            ...
            >
              <div className='p-5 sm:flex sm:gap-4'>
                {showIcon ? (
                  isDanger ? (
                    <div className='rounded-full mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center bg-red-100'>
                      <AlertTriangleIcon className='h-6 w-6 text-red-600' aria-hidden='true' />
                    </div>
                  ) : (
                    <div className='rounded-full mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center bg-blue-100'>
