  ...
  return (
    showBackToTop && (
      <div
        {...props}
        className={cn(
          'rounded-full fixed bottom-[18px] right-4 z-40 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:transform',
      ...
      >
        ...
        <button
          onClick={scrollToTop}
          className={cn(
            'rounded-full flex items-center gap-1 bg-transparent p-1 pl-1.5 text-[13px] text-neutral-700',
