...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      'rounded peer h-4 w-4 shrink-0 cursor-pointer border border-neutral-400 data-[state=checked]:bg-sky-600 data-[state=checked]:text-white dark:border-neutral-600',
