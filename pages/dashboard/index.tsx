        ...
        {totalAuthors ? (
          ...
          <Shimmer>
            <div className='space-y-3'>
              <div className='rounded h-7 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
              <div className='rounded h-4 w-32 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
            </div>
          </Shimmer>
        )}
        {totalBooks ? (
      ...
      <div className='mt-5 grid grid-cols-1 gap-5'>
        <div className='rounded-md border bg-white dark:border-neutral-800 dark:bg-neutral-900'>
          ...
          {bookByGenre ? (
            ...
            <div className='m-auto w-80 py-3'>
              <Shimmer className='rounded-full m-auto h-64 w-64'>
                <div className='rounded-full h-full w-full bg-neutral-300/70 dark:bg-neutral-700/50'></div>
              </Shimmer>
              <div className='mx-auto mb-3 mt-3 flex w-64 flex-wrap justify-center gap-x-4 gap-y-2'>
                <div className='rounded h-4 w-12 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-12 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-10 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-12 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                <div className='rounded h-4 w-12 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
            ...
            {bookByAuthor ? (
              ...
              <Shimmer className='rounded-xl px-8'>
                <div className='flex flex-row items-end gap-2 sm:gap-4 md:gap-8 lg:gap-10'>
                  <div className='rounded h-32 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-16 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-64 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-72 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-32 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-16 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-64 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
                  <div className='rounded h-72 w-16 bg-neutral-300/70 dark:bg-neutral-700/50'></div>
